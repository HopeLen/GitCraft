...
## Corpus Check
- 27 files · ~5,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 174 nodes · 304 edges · 26 communities (17 shown, 9 thin omitted)
...
Cohesion: 0.14
Nodes (14): Bounds, BlockPos, BlockPosData, BlockPos, Gson, List, Path, String (+6 more)
...
Cohesion: 0.40
Nodes (5): BlockPos, FabricClientCommandSource, Rotation, String, Place
...
- **Why does `PlacementRenderer` connect `PlacementRenderer.java` to `Mod Entry & Commands`, `.find`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **What connects `graphify`, `Setup`, `License` to the rest of the system?**
  _12 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Repo JSON Persistence` be split into smaller, more focused modules?**
